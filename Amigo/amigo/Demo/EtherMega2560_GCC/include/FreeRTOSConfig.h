...
// Otherwise for Arduino Mega Rev3 and Pololu SVP 1284P, Timer3 should be the default
    ...
    #define configCPU_CLOCK_HZ		( ( unsigned long ) 16000000 )	// Arduino Mega Rev3
    #define configTICK_RATE_HZ		( ( portTickType ) 500 )		// Use 500Hz for TIMER3

    #define configTOTAL_HEAP_SIZE	( (size_t ) ( 32000 ) )			// used for heap_1.c and heap2.c only
    ...
    #define configCPU_CLOCK_HZ		( ( unsigned long ) 20000000 )	// Pololu SVP
    #define configTICK_RATE_HZ		( ( portTickType ) 500 )		// Use 500Hz for TIMER3
    #define configTOTAL_HEAP_SIZE	( (size_t ) ( 14000 ) )			// used for heap_1.c and heap2.c only

#else // assume we're using an Arduino with 328p
...
//  #define configCPU_CLOCK_HZ		( ( unsigned long ) 16000000 )  // Arduino with 328p device
    ...
    #define configTOTAL_HEAP_SIZE	( (size_t ) ( 1450 ) )			// used for heap_1.c and heap2.c only
