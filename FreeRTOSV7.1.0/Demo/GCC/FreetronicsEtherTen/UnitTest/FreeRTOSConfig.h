...
//    #define portUSE_TIMER0                                          // portUSE_TIMER0 to use 8 bit Timer0
    ...
    #define configTICK_RATE_HZ		( ( portTickType ) 1000 )        // Use 200Hz for TIMER0 and 400Hz for TIMER1
...
/* ^ coverclock@diag.com 2012-03-28 */
	...
	// Was 1450.
    #define configTOTAL_HEAP_SIZE	( (size_t ) ( 1322 ) )			// used for heap_1.c and heap2.c only
